...
module.exports = async function play(client, interaction) {
  switch (interaction.options.getSubcommand()) {
    ...
    case 'song':
      ...
      break;
    case 'playlist':
      await subcommandPlaylist(client, interaction);
      break;
    default:
...
async function subcommandPlaylist(client, interaction) {
  const playlist = await Playlist.getByName(interaction.options.getString('name'));

  if(!playlist.songs) interaction.reply('No songs in this playlist, please try another');
